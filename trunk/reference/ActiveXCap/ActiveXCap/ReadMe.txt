========================================================================
    ACTIVEX CONTROL DLL : ActiveXCap Project Overview
========================================================================

ControlWizard has created this project for your ActiveXCap ActiveX Control
...
that make up your ActiveXCap ActiveX Control DLL.
...
ActiveXCap.ico
    ...
    is included by the main resource file ActiveXCap.rc.

/////////////////////////////////////////////////////////////////////////////
CActiveXCapCtrl control:

ActiveXCapCtrl.h
    This file contains the declaration of the CActiveXCapCtrl C++ class.

ActiveXCapCtrl.cpp
    This file contains the implementation of the CActiveXCapCtrl C++ class.

ActiveXCapPropPage.h
    This file contains the declaration of the CActiveXCapPropPage C++ class.

ActiveXCapPropPage.cpp
    This file contains the implementation of the CActiveXCapPropPage C++ class.

CActiveXCapCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CActiveXCapCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file ActiveXCap.rc.
...
stdafx.h, stdafx.cpp
    ...
    named ActiveXCap.pch and a precompiled types (PCT) file named stdafx.obj.
